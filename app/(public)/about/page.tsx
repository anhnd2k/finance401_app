            ...
            <div className="container mx-auto max-w-3xl px-4">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                        A personal journal where I
                        document everything I
                        learn about finance — from
                        first principles to
                        advanced concepts.
                    </p>
                </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-4 text-gray-600 dark:text-gray-400">
                        <p>
                            ...
                            money and markets, I
                            wrote it down. Over
                            time, those notes grew
                            into articles — and
                            those articles became
                            this blog.
                        </p>
                        <p>
                            The name
                            &ldquo;401&rdquo; is a
                            nod to going beyond
                            the basics. It&apos;s
                            not Finance 101 — the
                            surface-level stuff
                ...
                <section className="rounded-xl border border-blue-200 bg-blue-50 p-8 text-center dark:border-blue-900/40 dark:bg-blue-900/20">
                    <p className="text-gray-700 dark:text-gray-300">
                        This blog is a work in
                        progress — just like my
                        understanding of finance.
                        I write to think clearly,
                        and I publish to stay
                        honest.
                    </p>
