...
export default function AboutEditor() {
    ...
    useEffect(() => {
        LOCALES.forEach((lang) => {
            fetch(
                `/api/admin/pages?key=about&language=${lang}`
            )
                .then((r) => r.json())
                .then((data) => {
                    setPanels((prev) => ({
                ...
                {openLangs.map((lang) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isPreview ? (
                                <div
                                    className="prose prose-sm min-h-[400px] max-w-none rounded-lg border border-gray-300 bg-white p-5 dark:prose-invert prose-headings:font-bold prose-a:text-blue-600 prose-img:rounded-xl dark:border-gray-700 dark:bg-gray-800"
