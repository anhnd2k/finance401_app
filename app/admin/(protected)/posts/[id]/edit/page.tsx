...
import MultiPanelEditor, {
    type PanelVersion,
} from '../../MultiPanelEditor';
...
export default async function EditPostPage({
    ...
    const allVersions: PanelVersion[] =
        allVersionsRaw.map((v) => ({
            id: v.id,
            language: v.language,
            title: v.title,
            slug: v.slug,
